...
const NODE_TRANSLATIONS = {
  MiniMaxH3PromptDirector: {
    ...
    fields: {
      ...
      api_reasoning: "模型思考",
      json_mode: "JSON 模式",
      ref_image_1: "参考图 1（<Picture 1>）",
      ref_image_2: "参考图 2（<Picture 2>）",
      ref_image_3: "参考图 3（<Picture 3>）",
      ref_image_4: "参考图 4（<Picture 4>）",
      ref_image_5: "参考图 5（<Picture 5>）",
      ref_image_6: "参考图 6（<Picture 6>）",
      ref_image_7: "参考图 7（<Picture 7>）",
      ref_image_8: "参考图 8（<Picture 8>）",
      ref_image_9: "参考图 9（<Picture 9>）",
